        ...
        <div className="flex items-center justify-between md:justify-center w-full mt-5 space-x-2 duration-100">
            ...
            <div className="md:p-1 w-full">
                ...
                <div className="flex items-center space-x-4 md:space-x-7 mt-5">
                    ...
                    <button>
                    <img src="/phone.png" className="socialNetworks4 duration-50 w-4 sm:w-6 mm:w-9 mr-2 duration-100 cursor-pointer hover:scale-105"/>
                    </button>

                    <button>
                    <img src="/gmail.png" className="socialNetworks3 duration-150 w-4 sm:w-6 mm:w-9 mr-2 duration-100 cursor-pointer hover:scale-105"/>
                    </button>

                    <a target="_blanck" href="https://www.linkedin.com/in/matias-mu%C3%B1oz-00a7581b6/" role="button" >
                        <img src="/linkedin.png" className="socialNetworks2 duration-200 w-4 sm:w-6 mm:w-9 mr-2 duration-100 cursor-pointer hover:scale-105"/>
                    </a>

                    <a target="_blanck" href="https://github.com/MATIAS28" role="button" >
                        <img src="/github.png" className="socialNetworks1 w-4 sm:w-6 mm:w-9 mr-2 duration-100 cursor-pointer hover:scale-105"/>
                    </a>
